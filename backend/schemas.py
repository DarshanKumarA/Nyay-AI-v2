...
class DraftRequest(BaseModel):
    document_type: str # e.g., "Legal Notice", "Plaint", "Bail Application"
    filenames: List[str]
    user_instructions: Optional[str] = None # Optional specific instructions from the lawyer
